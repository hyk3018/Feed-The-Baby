...
#if UNITY_EDITOR
namespace FeedTheBaby.Editor.Dictionary
{
    ...
    public abstract class SerializableDictionaryDrawer<K, V> : PropertyDrawer
    {
        ...
        SerializedProperty GetTemplateKeyProp(SerializedProperty mainProp)
        {
            return GetTemplateProp(templateKeyProp, mainProp);
        }

        SerializedProperty GetTemplateValueProp(SerializedProperty mainProp)
        {
        ...
        Dictionary<int, SerializedProperty> templateKeyProp = new Dictionary<int, SerializedProperty>();
        Dictionary<int, SerializedProperty> templateValueProp = new Dictionary<int, SerializedProperty>();

        SerializedProperty GetKeysProp(SerializedProperty mainProp)
        {
            return GetCachedProp(mainProp, "keys", keysProps);
        }

        SerializedProperty GetValuesProp(SerializedProperty mainProp)
        {
            return GetCachedProp(mainProp, "values", valuesProps);
        }

        SerializedProperty GetCachedProp(SerializedProperty mainProp, string relativePropertyName,
        ...
        Dictionary<int, SerializedProperty> keysProps = new Dictionary<int, SerializedProperty>();
        Dictionary<int, SerializedProperty> valuesProps = new Dictionary<int, SerializedProperty>();

        Dictionary<int, Dictionary<int, SerializedProperty>> indexedPropertyDicts =
            new Dictionary<int, Dictionary<int, SerializedProperty>>();

        SerializedProperty GetIndexedItemProp(SerializedProperty arrayProp, int index)
        {
