...
namespace UnityEngine.Tilemaps
{
    ...
    public class GridInformation : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        Dictionary<GridInformationKey, GridInformationValue> m_PositionProperties =
        ...
        [SerializeField] [HideInInspector] List<GridInformationKey> m_PositionIntKeys = new List<GridInformationKey>();

        [SerializeField] [HideInInspector] List<int> m_PositionIntValues = new List<int>();

        [SerializeField] [HideInInspector]
        List<GridInformationKey> m_PositionStringKeys = new List<GridInformationKey>();

        [SerializeField] [HideInInspector] List<string> m_PositionStringValues = new List<string>();

        [SerializeField] [HideInInspector]
        List<GridInformationKey> m_PositionFloatKeys = new List<GridInformationKey>();

        [SerializeField] [HideInInspector] List<float> m_PositionFloatValues = new List<float>();

        [SerializeField] [HideInInspector]
        List<GridInformationKey> m_PositionDoubleKeys = new List<GridInformationKey>();

        [SerializeField] [HideInInspector] List<double> m_PositionDoubleValues = new List<double>();

        [SerializeField] [HideInInspector]
        List<GridInformationKey> m_PositionObjectKeys = new List<GridInformationKey>();

        [SerializeField] [HideInInspector] List<Object> m_PositionObjectValues = new List<Object>();

        [SerializeField] [HideInInspector]
        List<GridInformationKey> m_PositionColorKeys = new List<GridInformationKey>();

        [SerializeField] [HideInInspector] List<Color> m_PositionColorValues = new List<Color>();
        ...
        bool SetPositionProperty(Vector3Int position, string name, GridInformationType dataType,
