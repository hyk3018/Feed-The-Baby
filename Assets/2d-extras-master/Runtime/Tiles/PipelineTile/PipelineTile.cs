...
namespace UnityEngine.Tilemaps
{
    ...
    public class PipelineTile : TileBase
    {
        ...
        void UpdateTile(Vector3Int location, ITilemap tileMap, ref TileData tileData)
        {
        ...
        bool TileValue(ITilemap tileMap, Vector3Int position)
        {
        ...
        Matrix4x4 GetTransform(byte mask)
        {
            switch (mask)
            {
                case 9:
    ...
    {
        PipelineTile tile => target as PipelineTile;
