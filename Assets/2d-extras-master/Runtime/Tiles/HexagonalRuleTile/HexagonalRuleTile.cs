...
namespace UnityEngine
{
    ...
    /// </summary>
    [Serializable]
    [CreateAssetMenu(fileName = "New Hexagonal Rule Tile", menuName = "2D Extras/Tiles/Hexagonal Rule Tile",
        order = 359)]
    public class HexagonalRuleTile : RuleTile
    {
        public override int m_RotationAngle => 60;

        static float[] m_CosAngleArr1 =
        {
