...
namespace UnityEngine
{
    ...
    public class RuleTile : TileBase
    {
        ...
        HashSet<Vector3Int> m_NeighborPositions = new HashSet<Vector3Int>();
        ...
        public override bool StartUp(Vector3Int location, ITilemap tilemap, GameObject instantiatedGameObject)
        {
            if (instantiatedGameObject != null)
            {
                ...
                instantiatedGameObject.transform.localPosition =
                    gameObjectTranslation + tmpMap.CellToLocalInterpolated(location + tmpMap.tileAnchor);
