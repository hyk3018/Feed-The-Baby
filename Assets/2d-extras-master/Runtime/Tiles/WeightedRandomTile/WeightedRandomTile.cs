...
namespace UnityEngine.Tilemaps
{
    ...
    /// </summary>
    [Serializable]
    [CreateAssetMenu(fileName = "New Weighted Random Tile", menuName = "2D Extras/Tiles/Weighted Random Tile",
        order = 359)]
    ...
    public class WeightedRandomTileEditor : Editor
    {
        ...
        SerializedProperty m_ColliderType;

        WeightedRandomTile Tile => target as WeightedRandomTile;
