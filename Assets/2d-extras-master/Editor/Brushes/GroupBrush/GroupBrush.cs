...
namespace UnityEditor.Tilemaps
{
    ...
    public class GroupBrush : GridBrush
    {
        ...
        int visitedLocationsSize => (m_Limit.x * 2 + 1) * (m_Limit.y * 2 + 1) * (m_Limit.z * 2 + 1);

        [SerializeField] Vector3Int m_Gap = Vector3Int.one;
        [SerializeField] Vector3Int m_Limit = Vector3Int.one * 3;
        [SerializeField] BitArray m_VisitedLocations = new BitArray(7 * 7 * 7);
        [SerializeField] Stack<Vector3Int> m_NextPosition = new Stack<Vector3Int>();
        ...
        void Encapsulate(ref BoundsInt bounds, Vector3Int position)
        {
        ...
        int GetIndex(Vector3Int position, Vector3Int origin, Vector3Int size)
        {
        ...
        void PickCell(Vector3Int position, Vector3Int brushPosition, Tilemap tilemap)
        {
            if (tilemap != null)
            {
