...
namespace UnityEditor.Tilemaps
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "New Prefab Random Brush", menuName = "2D Extras/Brushes/Prefab Random Brush",
        order = 359)]
    [CustomGridBrush(false, true, false, "Prefab Random Brush")]
    public class PrefabRandomBrush : BasePrefabBrush
    {
        const float k_PerlinOffset = 100000f;
...
#pragma warning restore 0649
        ...
        static float GetPerlinValue(Vector3Int position, float scale, float offset)
        {
        ...
        {
            PrefabRandomBrush prefabRandomBrush => target as PrefabRandomBrush;
