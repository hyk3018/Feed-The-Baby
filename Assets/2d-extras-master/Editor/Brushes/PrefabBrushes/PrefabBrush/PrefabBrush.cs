...
#pragma warning restore 0649
        ...
        public override void Paint(GridLayout grid, GameObject brushTarget, Vector3Int position)
        {
            ...
            if (!existPrefabObjectInCell) InstantiatePrefabInCell(grid, brushTarget, position, m_Prefab);
        }
        ...
        {
            PrefabBrush prefabBrush => target as PrefabBrush;
            ...
            public override void OnPaintInspectorGUI()
            {
                ...
                prefabBrush.m_EraseAnyObjects =
                    EditorGUILayout.Toggle("Erase Any Objects", prefabBrush.m_EraseAnyObjects);
