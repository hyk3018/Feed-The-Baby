...
namespace UnityEditor.Tilemaps
{
    ...
    {
        [SerializeField] [HideInInspector] BrushCell[] m_Cells;

        [SerializeField] [HideInInspector] Vector3Int m_Size;

        [SerializeField] [HideInInspector] Vector3Int m_Pivot;

        [SerializeField] [HideInInspector] bool m_CanChangeZPosition;
        ...
        void PaintCell(GridLayout grid, Vector3Int position, Transform parent, BrushCell cell)
        {
        ...
        void EraseCell(GridLayout grid, Vector3Int position, Transform parent)
        {
        ...
        void PickCell(Vector3Int position, Vector3Int brushPosition, GridLayout grid, Transform parent)
        {
            if (parent != null)
            {
        ...
        static GameObject GetObjectInCell(GridLayout grid, Transform parent, Vector3Int position)
        {
        ...
        bool ValidateCellPosition(Vector3Int position)
        {
            var valid =
        ...
        static void SetSceneCell(GridLayout grid, Transform parent, Vector3Int position, GameObject go, Vector3 offset,
            Vector3 scale, Quaternion orientation, Vector3 anchor)
        {
        ...
        static void ClearSceneCell(GridLayout grid, Transform parent, Vector3Int position)
        {
            if (parent == null)
                return;
