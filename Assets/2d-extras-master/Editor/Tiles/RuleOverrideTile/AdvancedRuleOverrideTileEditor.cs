...
namespace UnityEditor
{
    ...
    public class AdvancedRuleOverrideTileEditor : RuleOverrideTileEditor
    {
        ...
        static float k_DefaultElementHeight => RuleTileEditor.k_DefaultElementHeight;
        static float k_SingleLineHeight => RuleTileEditor.k_SingleLineHeight;
        static float k_LabelWidth => RuleTileEditor.k_LabelWidth;
